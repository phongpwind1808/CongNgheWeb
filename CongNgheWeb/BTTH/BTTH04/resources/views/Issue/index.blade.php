    ...
    <div class="container-xl">
        <div class="table-responsive">
            <div class="table-wrapper">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="text-center">
                                    <!-- Nút Delete liên kết modal động -->
                                    <button class="btn btn-secondary" data-toggle="modal" data-target="#deleteModal-{{ $item->id }}">
                                        Delete
                                    </button>
                                </div>

                                <!-- Modal động cho từng bản ghi -->
                ...
                <div class="clearfix">
                    <div class="hint-text">
                        Showing <b>{{ $data->firstItem() }}</b> to <b>{{ $data->lastItem() }}</b> of <b>{{ $data->total() }}</b> entries
                    </div>
